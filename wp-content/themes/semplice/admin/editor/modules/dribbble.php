...
if(!class_exists('sm_dribbble')) {
	...
	class sm_dribbble {
		...
		public function output_editor($values, $id) {
			...
			// get shots
			if(empty($dribbble_token) && $media != 'curl' && $media != 'error' && true === $this->is_editor) {
				$this->output['html'] = '
					<div class="dribbble-error">
						' . get_svg('backend', '/icons/module_dribbble') . '
						<div class="content">
							<p>You are not connected yet.</p>
							<p class="sub">To connect Dribbble you will need a client access token.<br />Please read this <a href="http://help.semplice.com/customer/en/portal/articles/2176260-get-your-dribbble-client-access-token" target="_blank">guide</a> on how to get one.</p>
